  ...
  return (
    <div className="min-h-screen bg-white text-slate-700">
      ...
      <main className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <Section id="projects" eyebrow="Projects" title="Featured AI Project">
          <div className="grid gap-6 lg:grid-cols-1">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-lg shadow-slate-200/40">
              ...
              <p className="mt-3 text-slate-600">
                Built an AI-powered system that analyzes resumes and matches them with job descriptions using resume parsing, keyword alignment, ATS-style scoring, and job-fit evaluation.
              </p>

              <div className="mt-4 flex flex-wrap gap-2">
                <span className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs text-slate-700">Python</span>
                <span className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs text-slate-700">FastAPI</span>
                <span className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs text-slate-700">Streamlit</span>
                <span className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs text-slate-700">NLP</span>
