...
BACKEND_URL = "https://resume-intelligence-aggi.onrender.com/match"
    ...
    if not resume or not jd:
        ...
        with st.spinner("Reviewing resume fit and generating insights..."):
            try:
                ...
                st.error(
                    "The live analysis service could not be reached. Make sure the backend API is live and the /match route is enabled."
                )
